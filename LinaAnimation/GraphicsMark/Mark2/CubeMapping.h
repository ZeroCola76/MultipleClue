...
/// 2024.1.26. DXGI_FORMAT_R32_UINT 설정 변경 확인할 것
/// </summary>
class CubeMapping
{
public:
...
public:
	...
	void Initialize(ComPtr<ID3D11Device>& device, const wchar_t* originalFilename, const wchar_t* diffuseFilename, const wchar_t* specularFilename, vector<NestGraphics::MeshData>* modelMeshDataes);
