...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_WM_TIMER()
	//	ON_WM_ENTERIDLE()
	ON_COMMAND(ID_OPEN_DOCKING_PANE, &CMainFrame::OnOpenDockingPane)
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	*/
	...
	// TODO_DOYO : 상태바의 위치, ID, 크기를 설정
	m_wndStatusBar.SetPaneInfo(4, ID_INDICATOR_POINT, SBPS_NORMAL, 150);
	m_wndStatusBar.SetPaneInfo(5, ID_INDICATOR_FPS, SBPS_NORMAL, 150);
	...
	*/
	...
	// 메인 프레임에 도킹 팬 생성
	if (!m_paneInfo.Create(_T("Object Control"), this, CRect(0, 0, 200, 200), TRUE, 0xfafa
...
void CMainFrame::UpdateTime(int FPS, float ms)
{
	// TODO: 여기에 구현 코드 추가.
	CString str;
	str.Format(_T("%dFPS / %.2fms"), FPS, ms);
	m_wndStatusBar.SetPaneText(5, str);
}



void CMainFrame::OnOpenDockingPane()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	if (m_paneInfo.IsDocked())
	{
		m_paneInfo.DestroyWindow();
